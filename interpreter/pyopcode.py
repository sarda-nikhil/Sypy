...
from pypy.interpreter.constraintstack import ConstraintStack, Constraint
...
class __extend__(pyframe.PyFrame):
    ...
    def LOAD_FAST(self, varindex, next_instr):
        ...
        # Push the variable name in the symbolic stack
        self.pushvalue_s(self.pycode.co_varnames[varindex])
    ...
    def LOAD_CONST(self, constindex, next_instr):
        ...
        # Push the constant value as is into the symbolic stack
        self.pushvalue_s(w_const)
