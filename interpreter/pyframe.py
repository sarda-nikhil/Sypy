...
class PyFrame(eval.Frame):
    ...
    # Symbolic stackframe and other datastructures
    ...
    # symbolic stack manipulation helpers
    def pushvalue_s(self, w_object):
        depth = self.valuestackdepth
        self.locals_stack_w_s[depth] = w_object
        
    def popvalue_s(self):
        depth = self.valuestackdepth - 1
        assert depth >= self.pycode.co_nlocals, "pop from empty value stack"
        w_object = self.locals_stack_w_s[depth]
        self.locals_stack_w_s[depth] = None
        return w_object
    ...
    def descr__setstate__(self, space, w_args):
        ...
        new_frame.locals_stack_w_s = new_frame.locals_stack_w
